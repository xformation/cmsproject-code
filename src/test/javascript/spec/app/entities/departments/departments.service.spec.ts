    ...
    describe('Departments Service', () => {
        ...
        describe('Service methods', () => {
            ...
            it('should create a Departments', () => {
                service.create(new Departments(null)).subscribe(received => {
            ...
            it('should update a Departments', () => {
                service.update(new Departments(123)).subscribe(received => {
            ...
            it('should return a Departments', () => {
