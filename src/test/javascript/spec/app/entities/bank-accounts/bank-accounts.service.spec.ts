    ...
    describe('BankAccounts Service', () => {
        ...
        describe('Service methods', () => {
            ...
            it('should create a BankAccounts', () => {
                service.create(new BankAccounts(null)).subscribe(received => {
            ...
            it('should update a BankAccounts', () => {
                service.update(new BankAccounts(123)).subscribe(received => {
            ...
            it('should return a BankAccounts', () => {
            ...
            it('should return a list of BankAccounts', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new BankAccounts(123)]);
            });
